...
%endif
	...
	%{subst_enable static} \
	%{?_with_bootstrap:--disable-scripts} \
	#
...
%changelog
* Fri Feb 01 2019 Michael Shigorin <mike@altlinux.org> 0.5.15lorg2-alt53.5.M80C.1
- Removed moo (nbr@).
...
* Mon Feb 22 2016 Michael Shigorin <mike@altlinux.org> 0.5.15lorg2-alt53.3
- E2K: specify --host explicitly.

* Wed Feb 03 2016 Michael Shigorin <mike@altlinux.org> 0.5.15lorg2-alt53.2
- BOOTSTRAP: disable lua support, relax textrel/rpath checks.

* Tue Feb 02 2016 Michael Shigorin <mike@altlinux.org> 0.5.15lorg2-alt53.1
- TMP: drop manpages.
